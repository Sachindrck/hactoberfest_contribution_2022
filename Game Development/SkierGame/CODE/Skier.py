...
def Exit(screen, screensize, score):
    ...
    tfont1 = pygame.font.Font(cfg.TimesNewRoman, screensize[0]//40)
    cfont = pygame.font.Font(cfg.FONTPATH, screensize[0]//20)

    title2 = tfont.render(u'High Score: %d' % m, True, (0, 0, 139))
    title = tfont.render(u'Your Score : %s' % score, True, (255, 0, 0))

    content = cfont.render(u'Game Over!', True, (0, 0, 255))  # DISPLAY MESSAGE

    title3 = tfont1.render(u'Author: Anand Jaiswar', True, (3, 3, 3))
    ...
    trect3 = title3.get_rect()
    trect3.midtop = (screensize[0]/1.3, screensize[1]/1.09)
